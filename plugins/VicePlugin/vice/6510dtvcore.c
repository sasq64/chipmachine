...
#define SET_ABS_Y_RMW(old_value, new_value)    \
    SET_ABS_I_RMW(reg_y, old_value, new_value)
...
#define SET_ZERO_Y_RMW(old_value, new_value)    \
    SET_ZERO_I_RMW(reg_y, old_value, new_value)
