...
extern void serial_iec_bus_open(unsigned int device, BYTE secondary,
                                void(*st_func)(BYTE));
...
extern void serial_iec_bus_untalk(unsigned int device, BYTE secondary,
                                  void(*st_func)(BYTE));
extern void serial_iec_bus_write(unsigned int device, BYTE secondary, BYTE data,
                                 void(*st_func)(BYTE));
extern BYTE serial_iec_bus_read(unsigned int device, BYTE secondary,
                                void(*st_func)(BYTE));
