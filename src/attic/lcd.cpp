...
enum { LCD_RS = 7, LCD_E = 8, LCD_D4 = 25, LCD_D5 = 24, LCD_D6 = 23, LCD_D7 = 22 };

enum { E_DELAY = 500, E_PULSE = 500 };
...
enum { DG_LINE0 = 0x00, DG_LINE1 = 0x40, DG_LINE2 = 0x14, DG_LINE3 = 0x54 };
...
void lcd_init() {
	...
	vector<int> initSequence{FUNCTION | 0x13,
	                         FUNCTION | 0x12,
	                         FUNCTION | 0x8,
	                         DISPLAY_CTRL | 0x4,
	                         ENTRY_MODE | EM_LEFT_TO_RIGHT,
	                         CLEAR_DISPLAY};
